  ...
  return (
    <>
      ...
      <motion.p 
        ...
        className="text-sm sm:text-base md:text-lg font-light text-portfolio-muted mb-8 sm:mb-12 max-w-xs sm:max-w-md md:max-w-3xl mx-auto leading-relaxed px-2 sm:px-0"
      >
